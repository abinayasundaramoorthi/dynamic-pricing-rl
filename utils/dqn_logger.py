...
Usage (inside a training loop, e.g. training/train_dqn.py):
    ...
    for episode in range(num_episodes):
        ...
        logger.log(
            episode=episode,
            episode_reward=info["episode_revenue"],
...
class DQNLogger:
    ...
    def log(self, episode, episode_reward, epsilon, loss, buffer_size):
        """
        ...
        episode_reward : float
            Total reward earned during this episode.
